...
export const products = {
  ...
  items: [
    ...
    },
    {
      ...
      body: "Continuously reads team and product performance and tells you, in hard numbers, whether you’re still on the growth curve — and where the next margin is hiding. The screen below is a live Compass output.",
      points: [
        "KPI strip: Season Revenue €33.2M · 37.3% gross margin · driver consolidation −26.5%",
        "Gross-margin % per product line straight from the warehouse (marts.transfers)",
        "Live autoplanner across 6 real dates / 4,658 tasks — a working engine, with euros saved per day",
        "LTV-by-cohort + RFM segments — surfaced €2.8–3.2M / season in growth levers",
      ],
    },
    {
      name: "Forge",
